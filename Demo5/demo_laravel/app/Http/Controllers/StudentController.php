...
class StudentController extends Controller
{
    ...
    public function index()
    {
        ...
        ->get();
        */
        return view('student.index', ['students' => $students, 'clubs' => $clubs]);
    }
    ...
    {
        //
//        if (!Gate::allows('create-student',[Auth::user()])) { abort('403'); }
    ...
    public function clubs() {
        $clubs = Club::all();
        return view('student.clubs', ['clubs' => $clubs]);
    }
}
